...
public class lab0302 {
    public static void main(String[] args){
        ...
        //Give a doscpimt pf tem [ercemt pnly if the total cost exceeds $5000
        discount =  totalCost > 5000 ? totalCost * 10/100 : ( totalCost >= 3000 && totalCost < 5000 ) ? totalCost * 5/100 : 0;
        netPay = totalCost - discount;

        //Give one percent of the netPay as points only if the invoice amount exceeds #3000
        points = (int) (netPay > 5000 ? netPay / 100 : 0);
